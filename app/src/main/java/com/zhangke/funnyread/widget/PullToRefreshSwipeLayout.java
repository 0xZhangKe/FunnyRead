 ...
 */
public class PullToRefreshSwipeLayout extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
    ...
    public PullToRefreshSwipeLayout(Context context) {
        this(context, null);
    }
